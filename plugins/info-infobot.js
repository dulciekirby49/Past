...
╠
╠➥ [🤴🏻] CREATOR: *HOUSSAM*
╠➥ [#️⃣] NUMERO: *+212 672215449*
╠➥ [🎳] PREFIX: *${usedPrefix}*
╠➥ [🔐] CHATS PRIVATE: *${chats.length - groups.length}*
╠➥ [🦜] CHATS DE GROUPE: *${groups.length}* 
╠➥ [💡] CHATS TOTALES: *${chats.length}* 
╠➥ [🚀] UPTIME: *${uptime}*
╠➥ [🎩] USERS: *${totalreg} numero*
╠➥ [☑️] AUTOREAD: ${autoread ? '*Enable*' : '*Disable*'}
╠➥ [❗] RESTRICTE: ${restrict ? '*Enable*' : '*Disable*'} 
╠➥ [💬] PCONLY: ${pconly ? '*Enable*' : '*Disable*'}
╠➥ [🏢] GCONLY: ${gconly ? '*Enable*' : '*Disable*'}
╠➥ [🌎] MODO: ${self ? '*Private*' : '*Public*'}
╠➥ [💬] ANTIPRIVATE: ${antiprivado ? '*Enable*' : '*Disable*'}
╠➥ [🤖] MODEJADIBOT: ${modejadibot ? '*Enable*' : '*Disable*'}
╠➥ [📵] ANTILLAMADA: ${antiCall ? '*Enable*' : '*Disable*'}
╠➥ [👨‍🦯] SPEED: *${speed} ms* 
╠
╠═〘 https://www.instagram.com/houssam_iii/ 〙 ═
`.trim() 
