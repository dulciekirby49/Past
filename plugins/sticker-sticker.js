...
} else throw `*[❗INFO❗] ANSWER TO A VIDEO IMAGE OR INSERT THE LINK OF AN IMAGE TERMINATION .jpg WHICH WILL BE CONVERTED INTO A STICKER YOU MUST ANSWER OR USE THE COMMAND ${usedPrefix + command}*`
} catch {
stiker = '*[❗INFO❗] SORRY, AN ERROR OCCURRED, PLEASE GO BACK INTERNAL. DO NOT FORGET TO RESPOND TO A VIDEO IMAGE OR INSERT THE LINK OF AN IMAGE FINISHING .jpg WHICH WILL BE CONVERTED INTO A STICKER*'	
} finally {
m.reply(stiker)}}
handler.help = ['sfull']
